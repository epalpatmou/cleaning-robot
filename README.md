...
> Άνοιγμα αυτής της σελίδας στο [https://epalpatmou.github.io/cleaning-robot/](https://epalpatmou.github.io/cleaning-robot/)
...
* αναζήτηση για **https://github.com/epalpatmou/cleaning-robot** και εισαγωγή

## Επεξεργασία αυτού του έργου ![Σήμα κατάστασης κατασκευής](https://github.com/epalpatmou/cleaning-robot/workflows/MakeCode/badge.svg)

Για επεξεργασία αυτού του αποθετηρίου στο MakeCode.

* άνοιγμα [https://makecode.microbit.org/](https://makecode.microbit.org/)
* κάντε κλικ στην **Εισαγωγή** και έπειτα στην **Εισαγωγή διεύθυνσης URL**
* επικολλήστε **https://github.com/epalpatmou/cleaning-robot** και κάντε κλικ στην εισαγωγή
...
![Προβολή απόδοσης των μπλοκ](https://github.com/epalpatmou/cleaning-robot/raw/master/.github/makecode/blocks.png)
